...
struct JlHepMC3_ULongLongAttribute: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("from_string", [](HepMC3::ULongLongAttribute& a, const std::string & arg0)->bool { return a.from_string(arg0); });
    t.method("from_string", [](HepMC3::ULongLongAttribute* a, const std::string & arg0)->bool { return a->from_string(arg0); });
    ...
    t.method("to_string", [](HepMC3::ULongLongAttribute const& a, std::string & arg0)->bool { return a.to_string(arg0); });
    t.method("to_string", [](HepMC3::ULongLongAttribute const* a, std::string & arg0)->bool { return a->to_string(arg0); });
    ...
    t.method("value", [](HepMC3::ULongLongAttribute const& a)->unsigned long long { return a.value(); });
    t.method("value", [](HepMC3::ULongLongAttribute const* a)->unsigned long long { return a->value(); });
    ...
    t.method("set_value", [](HepMC3::ULongLongAttribute& a, const unsigned long long & arg0)->void { a.set_value(arg0); });
    t.method("set_value", [](HepMC3::ULongLongAttribute* a, const unsigned long long & arg0)->void { a->set_value(arg0); });
  }
