...
struct JlHepMC3_StringAttribute: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("from_string", [](HepMC3::StringAttribute& a, const std::string & arg0)->bool { return a.from_string(arg0); });
    t.method("from_string", [](HepMC3::StringAttribute* a, const std::string & arg0)->bool { return a->from_string(arg0); });
    ...
    t.method("to_string", [](HepMC3::StringAttribute const& a, std::string & arg0)->bool { return a.to_string(arg0); });
    t.method("to_string", [](HepMC3::StringAttribute const* a, std::string & arg0)->bool { return a->to_string(arg0); });
    ...
    t.method("value", [](HepMC3::StringAttribute const& a)->std::string { return a.value(); });
    t.method("value", [](HepMC3::StringAttribute const* a)->std::string { return a->value(); });
    ...
    t.method("set_value", [](HepMC3::StringAttribute& a, const std::string & arg0)->void { a.set_value(arg0); });
    t.method("set_value", [](HepMC3::StringAttribute* a, const std::string & arg0)->void { a->set_value(arg0); });
  }
