...
struct JlHepMC3_DoubleAttribute: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("from_string", [](HepMC3::DoubleAttribute& a, const std::string & arg0)->bool { return a.from_string(arg0); });
    t.method("from_string", [](HepMC3::DoubleAttribute* a, const std::string & arg0)->bool { return a->from_string(arg0); });
    ...
    t.method("to_string", [](HepMC3::DoubleAttribute const& a, std::string & arg0)->bool { return a.to_string(arg0); });
    t.method("to_string", [](HepMC3::DoubleAttribute const* a, std::string & arg0)->bool { return a->to_string(arg0); });
    ...
    t.method("value", [](HepMC3::DoubleAttribute const& a)->double { return a.value(); });
    t.method("value", [](HepMC3::DoubleAttribute const* a)->double { return a->value(); });
    ...
    t.method("set_value", [](HepMC3::DoubleAttribute& a, const double & arg0)->void { a.set_value(arg0); });
    t.method("set_value", [](HepMC3::DoubleAttribute* a, const double & arg0)->void { a->set_value(arg0); });
  }
