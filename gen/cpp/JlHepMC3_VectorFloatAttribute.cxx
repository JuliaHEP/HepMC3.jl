...
struct JlHepMC3_VectorFloatAttribute: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("from_string", [](HepMC3::VectorFloatAttribute& a, const std::string & arg0)->bool { return a.from_string(arg0); });
    t.method("from_string", [](HepMC3::VectorFloatAttribute* a, const std::string & arg0)->bool { return a->from_string(arg0); });
    ...
    t.method("to_string", [](HepMC3::VectorFloatAttribute const& a, std::string & arg0)->bool { return a.to_string(arg0); });
    t.method("to_string", [](HepMC3::VectorFloatAttribute const* a, std::string & arg0)->bool { return a->to_string(arg0); });
    ...
    t.method("value", [](HepMC3::VectorFloatAttribute const& a)->std::vector<float> { return a.value(); });
    t.method("value", [](HepMC3::VectorFloatAttribute const* a)->std::vector<float> { return a->value(); });
    ...
    t.method("set_value", [](HepMC3::VectorFloatAttribute& a, const std::vector<float> & arg0)->void { a.set_value(arg0); });
    t.method("set_value", [](HepMC3::VectorFloatAttribute* a, const std::vector<float> & arg0)->void { a->set_value(arg0); });
  }
